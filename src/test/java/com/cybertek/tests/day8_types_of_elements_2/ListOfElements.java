...
public class ListOfElements {
    ...
    public void test1(){
       ...
       //verify button size
        ...
        for (WebElement button : buttons) {
            ...
            System.out.println("buttons: " + button.isDisplayed());
    ...
    public void test2() {
        ...
        //driver.findElement(By.tagName("buttonahgdhjgsd")); ---> throws error
        //this will not throw any error (ALT + Enter --> shortcut)
        List<WebElement> buttons = driver.findElements(By.tagName("buttonahgdhjgsd"));

        System.out.println("buttons.size() = " + buttons.size());
        //this will give 0, because there is no such element
